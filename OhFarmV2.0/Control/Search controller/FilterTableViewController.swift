...
class FilterTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if filter == nil {
            filter = Filter([[Category.vegetable.rawValue,Category.herb.rawValue],[PlantLoaction.indoor.rawValue,PlantLoaction.outdoor.rawValue],0,100,0,100])
        }
    }
